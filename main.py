...
def main():
    ...
    new_run_parser.add_argument('--data-dir', '-d', default='',
                                type=str,
                                help='The directory where the data is stored.')
    new_run_parser.add_argument('--batch_size', '-b', default=64, type=int, help='The batch size.')
    new_run_parser.add_argument('--epochs', '-e', default=100, type=int,
                                help='Number of epochs to run the simulation.')
    new_run_parser.add_argument('--name', type=str, help='The name of the experiment.')
    ...
    new_run_parser.add_argument('--message', '-m', default=50, type=int, help='The length in bits of the watermark.')
    new_run_parser.add_argument('--cfolder', '-c', default='', type=str,
    ...
    new_run_parser.add_argument('--noise', default='QuantizationPlaceholder', type=str, nargs='*',
    ...
    continue_parser.add_argument('--data-dir', '-d', default='', required=False, type=str,
    ...
    if args.command == 'continue':
        ...
        # Update start epoch based on the checkpoint
        train_options.start_epoch = checkpoint['epoch'] + 1

        # Override data directories if provided
        if args.data_dir is not None:
            print("lujing:",args.data_dir)

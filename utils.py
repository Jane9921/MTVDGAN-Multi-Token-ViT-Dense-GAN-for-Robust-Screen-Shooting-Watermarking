...
from model.MTVDGAN import ARWGAN
...
def save_images_train(original_images, watermarked_images, diff_images, noise_images, epoch, folder, resize_to):  # resize_to = None
    ...
    print("folder", folder)
    print("watermarked_images", watermarked_images)
    print("noise_images", noise_images)
    filename = os.path.join(folder, 'epoch-{}.png'.format(epoch))
    print("stacked_images", stacked_images)
    print("filename", filename)
    print("original_images.shape[0]", original_images.shape[0])
    torchvision.utils.save_image(stacked_images, filename, nrow=original_images.shape[0], normalize=False, format='PNG')

def save_images(original_images, watermarked_images, epoch, folder, resize_to):  # resize_to = None
    images = original_images[:original_images.shape[0], :, :, :].cpu()
    watermarked_images = watermarked_images[:watermarked_images.shape[0], :, :, :].cpu()
...
def save_images_noise(noised_images, epoch, folder, resize_to):  # resize_to = None
    ...
    print("watermarked_images", noised_images)
    filename = os.path.join(folder, 'epoch-{}.png'.format(epoch))
    print("filename", filename)
    torchvision.utils.save_image(noised_images, filename, nrow=noised_images.shape[0], normalize=False,
                                 format='PNG')

def save_images_test(original_images, noise_images, filename, folder, resize_to):  # resize_to = None
    images = original_images[:original_images.shape[0], :, :, :].cpu()
    noise_images = noise_images[:noise_images.shape[0], :, :, :].cpu()
    ...
    print("filename", filename)
    print("original_images.shape[0]", original_images.shape[0])
    torchvision.utils.save_image(noise_images, filename, nrow=original_images.shape[0], normalize=False, format='PNG')

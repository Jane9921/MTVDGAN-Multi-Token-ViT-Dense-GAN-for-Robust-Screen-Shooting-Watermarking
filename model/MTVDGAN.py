...
class ARWGAN:
    def __init__(self, configuration: HiDDenConfiguration, device: torch.device, noiser: ScreenShooting, tb_logger):
    ...
    def to(self, *args, **kwargs):
        # 确保调用 nn.Module 的 to 方法
        return super(ARWGAN, self).to(*args, **kwargs)
